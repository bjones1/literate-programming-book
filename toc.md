...
3. Interleaved documentation and code longevity
   1. Meta-code: believing is seeing
   2. Writing to learn: documentation as design
   3. Writing to teach: documentation as description
   4. Writing to remember: documentation as database
   5. Writing to reflect: documentation as introspection
4. Tools and techniques for version control
   1. Introduction to distributed version control systems (DVCS)
   2. Storytelling through DVCS history: branches and commits
   3. Collaborative techniques for DVCS: merge and rebase
   4. Social coding: DVCS integration with GitHub
